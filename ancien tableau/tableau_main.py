...
valeur_derivee_en_0, derivee, x , fonction_initiale , valeur_de_x_latex = calculer_derivee(valeur_borne_1, valeur_borne_2, '(x-2)*(x-1)*(x+1)*(x+2)')
...
afficher_latex(fonction_initiale , derivee , valeur_de_x_latex , signes , variations_fonction_latex , derniere_variation_latex)